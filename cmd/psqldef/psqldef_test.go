...
func TestPsqldefAddIdentityColumnWithSequenceOption(t *testing.T) {
	...
	alter := `ALTER TABLE "public"."voltages" ADD COLUMN "volt" int NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH -100 INCREMENT BY 5 MINVALUE -100 MAXVALUE 100);`
